...
<head>
<meta charset="UTF-8">
<title>Denúncias Arquivadas | SDAC</title>
...
<h4 class="m-0">SDAC - Denúncias Arquivadas</h4>
</div>
<div></div>
</div>
</header>
...
<td><span class="badge bg-secondary text-white"><?= htmlspecialchars($d['nome_estado']) ?></span></td>
<td>
<!-- Botão para abrir modal de pedir mais info -->
<button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#modal<?= $d['id'] ?>">
<i class="bi bi-info-circle"></i> Pedir Info
</button>
...
<!--<form method="POST" action="pedirInfo.php">-->
    <form method="POST" action="">

<input type="hidden" name="id_denuncia" value="<?= $d['id'] ?>">
<div class="modal-header">
<h5 class="modal-title">Pedir Mais Informação - <?= htmlspecialchars($d['protocolo']) ?></h5>
<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
</div>
<div class="modal-body">
<div class="mb-3">
<label>Mensagem:</label>
<textarea class="form-control" name="mensagem" rows="4" placeholder="Solicite informações adicionais..."></textarea>
</div>
</div>
